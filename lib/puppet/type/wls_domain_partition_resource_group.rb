...
module Puppet
  Type.newtype(:wls_domain_partition_resource_group) do
    include EasyType
    ...
    on_create do | command_builder |
      ...
      template('puppet:///modules/orawls/providers/wls_domain_partition_resource_group/create_modify.py.erb', binding)
    end
    ...
    on_destroy do | command_builder |
      ...
      template('puppet:///modules/orawls/providers/wls_domain_partition_resource_group/destroy.py.erb', binding)
    end
