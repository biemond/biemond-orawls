...
module Puppet
  ...
  Type.newtype(:wls_foreign_jndi_provider) do
    ...
    on_create  do | command_builder |
      ...
      template('puppet:///modules/orawls/providers/wls_foreign_jndi_provider/create.py.erb', binding)
    end

    on_modify  do | command_builder |
      Puppet.info "modify #{name} "
      template('puppet:///modules/orawls/providers/wls_foreign_jndi_provider/modify.py.erb', binding)
    end
