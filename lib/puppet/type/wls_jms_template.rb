...
module Puppet
  ...
  newtype(:wls_jms_template) do
    ...
    on_create  do | command_builder |
      ...
      template('puppet:///modules/orawls/providers/wls_jms_template/create.py.erb', binding)
    end

    on_modify  do | command_builder |
      Puppet.info "modify #{name} "
      template('puppet:///modules/orawls/providers/wls_jms_template/modify.py.erb', binding)
    end
