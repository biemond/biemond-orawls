...
define orawls::domain (
  ...
  $domain_log_filecount                         = 10,
  $domain_log_rotationtype                      = 'byTime',
  $domain_log_file_min_size                     = 5000,
  $domain_log_file_timespan                     = 24,
  $domain_log_number_of_files_limited           = true,
  ...
  $adminserver_log_filecount                    = 10,
  $adminserver_log_file_min_size                = 5000,
  $adminserver_log_rotationtype                 = 'byTime',
  $adminserver_log_file_timespan                = 24,
  $adminserver_log_number_of_files_limited      = true,
  $adminserver_log_redirect_stdout_to_server    = false,
  $adminserver_log_redirect_stderr_to_server    = false,
  $adminserver_log_http_filecount               = 10,
  $adminserver_log_http_file_min_size           = 5000,
  $adminserver_log_http_rotationtype            = 'bySize',
  $adminserver_log_http_file_timespan           = 24,
  $adminserver_log_http_number_of_files_limited = true,
