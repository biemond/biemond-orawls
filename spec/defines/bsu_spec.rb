...
describe 'orawls::bsu', :type => :define do
    ...
    describe "extract patch" do
      it { 
           should contain_exec("extract p17572726_1036_Generic.zip").with({
             'command'  => 'unzip -n /install/p17572726_1036_Generic.zip -d /opt/oracle/middleware11gR1/utils/bsu/cache_dir',
  ...
  describe "CentOS local" do
    ...
    describe "extract patch" do
      it { 
           should contain_exec("extract p17572726_1036_Generic.zip").with({
             'command'  => 'unzip -n /mnt/p17572726_1036_Generic.zip -d /opt/oracle/middleware11gR1/utils/bsu/cache_dir',
           }).that_comes_before('Bsu_patch[FCX7]')  
         }  
    end
